...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="exjhipster03App.jobHistory.delete.question">
        <Translate contentKey="exjhipster03App.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
