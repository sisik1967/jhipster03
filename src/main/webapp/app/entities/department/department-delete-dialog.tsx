...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="exjhipster03App.department.delete.question">
        <Translate contentKey="exjhipster03App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
