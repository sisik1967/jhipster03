  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="exjhipster03App.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="exjhipster03App.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('exjhipster03App.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('exjhipster03App.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('exjhipster03App.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('exjhipster03App.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('exjhipster03App.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
